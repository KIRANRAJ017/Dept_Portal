...
function Login() {
    ...
    const [email, setemail] = useState('');
     ...
     async function handleSubmit(e){
        ...
        try{
            await axios.post("http://localhost:8000/student_login",{
                email,password
            })
            .then(res=>{
                
                if(res.data=="exist"){
                    history('/student_home')
                }
                 ...
                 <Components.Overlay signinIn={signIn}>
                     ...
                     <Components.RightOverlayPanel signinIn={signIn}>
                       ...
                       <Components.Paragraph>
                           Enter Your personal details and start journey with us{toggle}<br/><br/><b>Student Login</b>
                       </Components.Paragraph> 
